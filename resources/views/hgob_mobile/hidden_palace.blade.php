...
<x-hanging-gardens-of-bali-mobile>
    <div class="wrapper page">
        ...
        <div class="container-fluid accommodation py-2">
                ...
                <div class="row">
                    <div class="col-12 py-3">
                        ...
                        <div class="button-wrapper text-center">
                            <button type="button" class="btn btn-custom w-100 py-2" data-bs-toggle="modal" data-bs-target="#hp-inquiry">
                                Inquire Now
                            </button>
                        </div>
                    </div>
            ...
            <!-- Inquiry Modal -->
            <div class="modal fade" id="hp-inquiry" tabindex="-1" aria-labelledby="hp-inquiryLabel" aria-hidden="true">
                <form class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" method="post" action="{{route('inquiry.store')}}">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h2 class="modal-title text-uppercase" id="hp-inquiryLabel">Inquiry Form</h2>
                            ...
                            <div class="d-flex justify-content-center">
                                <div class="col-12">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-12 col-md-6 mb-2">
                                            <label for="reserveddate_enquiry" class="form-label">Reserved Date<span class="text-danger">*</span></label>
                                            <div class="input-group rounded-0">
                                                <span class="input-group-text rounded-0 px-3"><i class="fa fa-calendar" style="width: 16px;"></i></span>
                                                <input type="text" class="datepicker form-control rounded-0" name="date" id="reserveddate_enquiry" required="true" readonly="true">
                                            </div>
                                        </div>
                                        @push('js')
                                        <script>
                                            $('#reserveddate_enquiry').datepicker({ format: 'dd-mm-yyyy', startDate: "08-02-2023", autoclose: true });
                                        </script>
                                        @endpush
                                        <div class="col-12">
