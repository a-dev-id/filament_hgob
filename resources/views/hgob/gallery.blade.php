        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-10 offset-md-1 text-center">
                    <h1 class="underline fw-bold text-uppercase">Ubud Honeymoon Resort Gallery</h1>
                    <h2>Bali luxury romantic villas</h1>
                        <p>Here is a glimpse of what you can expect: Ubud luxury villa with Private Pool, Bali best fine dining and Bali best spa</p>
                </div>
            </div>
        </div>
                            ...
                            <div class="col-sm-12">
                                <div id="gallery" class="grid">
                                    ...
                                    <div data-src="{{ asset('storage/' . $data->image) }}" class="grid-item @foreach ($data->categories as $subdata) {{ $subdata->slug . '-item' }} @endforeach">
                                        <img src="{{ asset('storage/' . $data->thumb) }}" alt="{{ $setting->title }}">
                                    </div>
                                    @endforeach
                                </div>
                            </div>
