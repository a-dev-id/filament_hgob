            ...
            <div class="row">
                <div class="col-12 col-md-4 border-end border-secondary">
                    <div class="mb-3">
                        ...
                        <p class="fs-5 mb-0">10 am to 10 pm</p>
                    </div>
                    <div class="mb-3">
                        <h4 class="text-uppercase mb-0" style="font-size: 12px;">Booking</h4>
                        <p class="fs-5 mb-0">Advance booking recommended</p>
                    </div>
                    <div class="mb-3">
                        <h4 class="text-uppercase mb-0" style="font-size: 12px;">Contact</h4>
                        <p class="fs-5 mb-0">
                            <a href="mailto:spa@hanginggardensofbali.com" class="link-dark text-decoration-none d-block mb-0">spa@hanginggardensofbali.com</a>
                            <a href="tel:+62-361 982 700" class="link-dark text-decoration-none d-block mb-0">+62-361 982 700</a>
                        </p>
                    </div>
                    <div class="mt-1">
                        <a href="{{$setting->button_link}}" download="spa-menu" class="btn btn-gold text-uppercase px-3 py-2 rounded-0"><i class="fas fa-download me-2"></i> {{$setting->button_text}}</a>
                    </div>
                </div>
                <div class="col-12 col-md-8 ps-5">
                    <img src="{{asset('images/award-spa.png')}}" class="float-start me-4 mt-2" style="height: 100px;">
                    <div class="lh-lg">
                        {!! $setting->description !!}
                    </div>
                </div>
                ...
                <div class="row">
                    @if($loop->iteration % 2 == 0) <div class="col-12 col-md-5 d-flex flex-column justify-content-between order-3"> @else <div class="col-12 col-md-5 d-flex flex-column justify-content-between order-1"> @endif
                            <div class="pe-3">
                                ...
                                <h5 class="fw-bold">{{$data->price}} per {{$data->per}}</h5>
