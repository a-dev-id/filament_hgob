            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title fw-bold text-uppercase" id="{{$data->slug}}-label">The Intimate Wedding</h5>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-sm btn-gold text-uppercase py-2 px-3 rounded-0" data-bs-toggle="modal" data-bs-target="#{{'modalinquiry'.$data->id}}" data-bs-dismiss="modal">Inquire Now</button>
                    </div>
                </div>
            </div>
        </div>
