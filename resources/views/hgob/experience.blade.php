                ...
                <div class="row">
                    @if($loop->iteration % 2 == 0) <div class="col-12 col-md-5 order-3"> @else <div class="col-12 col-md-5 order-1"> @endif
                            <div class="pt-0 pb-5 border-bottom border-secondary">
                                ...
                                <p class="experience-subtitle mt-3 mb-0">{{$data->subtitle}}</p>
                            </div>
                            ...
                            <div class="py-5 border-bottom border-secondary">
                                <div class="row">
                                    <div class="col-12 col-md-7">
                                        <p class="fs-5 mb-1">From</p>
                                        <p class="experience-price my-0 pe-3 fs-2">{{$data->price}}</p>
                                        <p class=" fs-5 mt-1 mb-0">Per {{$data->per}}</p>
                                    </div>
                                    <div class="col-12 col-md-5 d-flex align-items-center">
                                        <button type="button" class="btn btn-gold text-uppercase w-100 py-3 fw-bold rounded-0" data-bs-toggle="modal" data-bs-target="#{{'modalinquiry'.$data->id}}">
                                            {{ $data->button_text }}
                                        </button>
                                            ...
                                            <form class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" method="post" action="{{route('inquiry.store')}}">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="submit" class="btn btn-gold text-uppercase py-2 fw-bold rounded-0">{{ $data->button_text }}</button>
                                                    </div>
                                                </div>
                                            </form>
                        ...
                        <div class="col-12 col-md-1 order-2 d-flex align-items-center justify-content-center">
                            <div class="d-inline-flex flex-column align-items-center">
                                ...
                                <a onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=700');return false;" href="//www.facebook.com/sharer/sharer.php?u={{route('experiences.index')}}" target="_blank" class="experience-share experience-share-fb"><i class="fab fa-facebook-f"></i></a>
                                <a onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=700');return false;" href="//twitter.com/intent/tweet?text={{$setting->title.' - '.$data->title}} ({{$data->subtitle}}): {{route('experiences.index')}}" target="_blank" class="experience-share experience-share-tw"><i class="fab fa-twitter"></i></a>
                            </div>
                        </div>
